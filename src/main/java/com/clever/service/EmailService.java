...
public class EmailService {
	...
	public MimeMessage createMessage(String to) throws MessagingException, UnsupportedEncodingException {
		...
		message.setSubject("Clever 이메일 인증"); // 제목
		
		String msgg = "";
		msgg += "<div style='margin:100px;'>";
		msgg += "<h1> 안녕하세요</h1>";
		msgg += "<h1> Clever 입니다</h1>";
		msgg += "<br>";
		msgg += "<p>아래 코드를 Clever로 돌아가 입력해주세요<p>";
		msgg += "<br>";
		...
		message.setFrom(new InternetAddress("hyeongjoopark03242@gmail.com", "박형주")); // 보내는 사람
